...
///
    ...
    protected:
        ...
        Parameters *layer_initial_parameters_ptr;
        ParameterContainer *current_param_container_ptr; // constant pointer, pointing to the current parameter pointer
        int layer_n;
    ...
    public:
        ...
        Parameters *get_initial_parameter_pointer() {
            return layer_initial_parameters_ptr;
        }

        void set_layer_n(int _layer_n) {
            layer_n = _layer_n;
        }
        ...
        virtual void set_param_ptr(ParameterContainer *_current_param_container_ptr) {
            current_param_container_ptr = _current_param_container_ptr;
        }
        ...
        ///
        /// Update parameters after back-propagation component-wise
        ///
        /// \param opt The optimization algorithm to be used. See the Optimizer class.
        ///
        virtual void update_cw(Optimizer *opt) = 0;
        ...
        virtual void aggregate(const Layer &) = 0;

        virtual void copy(const Layer &) = 0;

        virtual void reset() = 0;

        virtual void normalize_derivatives(float factor) = 0;
    };
