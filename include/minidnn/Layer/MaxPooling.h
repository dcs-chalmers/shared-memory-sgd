#ifndef LAYER_MAXPOOLINGSGD_H_
#define LAYER_MAXPOOLINGSGD_H_
...
#include "../Parameters/MaxPoolingParameters.h"
...
///
    ...
    public:
        ...
        MaxPooling(MaxPooling &layer) = default;

        void init(const Scalar &mu, const Scalar &sigma, RNG &rng) {
            layer_initial_parameters_ptr = new MaxPoolingParameters();
        }
        ...
        void aggregate(const Layer &) {

        }


        void copy(const Layer &) override {
